...
var _Blog = _interopRequireDefault(__webpack_require__(29));

var _header = _interopRequireDefault(__webpack_require__(30));
...
function (_React$Component) {
  ...
  _createClass(App, [{
    key: "selectMenu",
    value: function selectMenu(n) {
      this.setState({
        activeMenu: n
      });
    }
  }, {
    key: "renderSelectedMenu",
    value: function renderSelectedMenu() {
      if (this.state.activeMenu === 1) {
        return _react.default.createElement(_Home.default, null);
      }

      if (this.state.activeMenu === 2) {
        return _react.default.createElement(_Blog.default, null);
      }
    }
  }, {
    key: "render",
  ...
  _createClass(Header, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        className: this.state.c_nav1,
        onClick: function onClick() {
          return _this2.toggleActive(1);
        }
      }, "Home"), _react.default.createElement("button", {
        className: this.state.c_nav2,
        onClick: function onClick() {
          return _this2.toggleActive(2);
        }
      }, "Blog"), _react.default.createElement("button", {
        className: this.state.c_nav3,
        onClick: function onClick() {
          return _this2.toggleActive(3);
        }
      }, "About")));
    }
  }]);
